...
@section('heading', 'Add Promo')

@section('right_top_button')
<a href="{{ route('admin_promo') }}" class="btn btn-primary"><i class="fa fa-eye"></i> Back</a>
@endsection
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_promo_store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
